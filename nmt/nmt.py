...
def extend_hparams(hparams):
  ...
  # Best evaluation model on dev dataset.
  hparams.add_hparam("best_ppl", 999999999.0)
  hparams.add_hparam("best_ppl_dir", os.path.join(hparams.out_dir, "best_ppl_dir"))
...
def create_or_load_hparams(
  ...
  if save_hparams:
    ...
    utils.save_hparams(hparams.best_ppl_dir, hparams)
